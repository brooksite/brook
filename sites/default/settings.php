...
// Database connection settings.
/*$databasesi['ccdf_db']['default'] = array(
      'database' => 'ccdf_search',
      'username' => 'web',
      'password' => 'web',
      'host' => 'localhost',
      'port' => '',
 ...
 */
$settings['hash_salt'] = 'kSrtT4cu64N6UpB5axBcRbEO9PL54daJG4LkTxUStpFG4n-l3mY2nkpKnN_uqrWA4-LNzrGlUQ';
...
$config_directories['sync'] = __DIR__ . '/files/config_G5dwxqG5w2TPNoLccE0waYU3xNxcItTBkN8o_-8rnyluw96E4i9bO29lXuPbO76DCSSEl5r_Dg/sync';
...
if (file_exists('/var/www/html/ccdf.urban.org/ccdf-settings.inc')) {
  require '/var/www/html/ccdf.urban.org/ccdf-settings.inc';
}
  // We are running locally
  else {

    // Include external database
    #require '/vagrant/ccdf_extra_settings.inc';

    // Set a fake environment variable
    $_ENV['URBAN_SITE_ENVIRONMENT'] = 'vagrant';
    ...
    //Secure Pages
    //$conf['securepages_basepath'] = 'http://localhost:8080';
    //$conf['securepages_basepath_ssl'] = 'https://localhost:8443';
  ...
  $urban_site_env = getenv("URBAN_SITE_ENVIRONMENT");

  if (isset($urban_site_env) && !isset($_ENV['URBAN_SITE_ENVIRONMENT'])) {

    $_ENV['URBAN_SITE_ENVIRONMENT'] = $urban_site_env;

    switch ($_ENV['URBAN_SITE_ENVIRONMENT']) {

      case 'stg':
        // Environment indicator settings.
        $conf['environment_indicator_overwrite'] = TRUE;
        $conf['environment_indicator_overwritten_name'] = 'STAGING';
        $conf['environment_indicator_overwritten_color'] = '#0f4b7d';
        // Secure pages
        // $conf['securepages_basepath'] = 'http://stg.taxpolicycenter.org';
        // $conf['securepages_basepath_ssl'] = 'https://stg.taxpolicycenter.org';

        // Stg and Prod Composer settings
        $conf['composer_manager_autobuild_file'] = 0;
        $conf['composer_manager_autobuild_packages'] = 0;

        // Shield
        $conf['shield_user'] = 'idgprojects';
        $conf['shield_pass'] = 'idgprojects';
        // Robots
        $conf['robotstxt'] = "User-agent: *\nDisallow: *";
      ...
      case 'prod':
        ...
        $conf['environment_indicator_overwrite'] = TRUE;
        $conf['environment_indicator_overwritten_name'] = 'LIVE SITE';
        $conf['environment_indicator_overwritten_color'] = '#008aaf';
