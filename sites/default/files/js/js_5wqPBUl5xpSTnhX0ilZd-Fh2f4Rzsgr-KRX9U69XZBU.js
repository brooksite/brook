...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.tableDrag = function (table, tableSettings) {
    ...
    $table.before($('<button type="button" class="link tabledrag-toggle-weight btn btn-info btn-xs"></button>')
  ...
  Drupal.tableDrag.prototype.makeDraggable = function (item) {
    ...
    // Create the handle.
    var handle = $('<a href="#" class="tabledrag-handle"><div class="glyphicon glyphicon-move handle">&nbsp;</div></a>').attr('title', Drupal.t('Drag to re-order'));
  ...
  $.extend(Drupal.theme, {
    tableDragChangedMarker: function () {
      return '<span class="glyphicon glyphicon-warning-sign tabledrag-changed text-warning" title="' + Drupal.t('Changed') + '">&nbsp;</span>';
    },
...
(function ($) {
  ...
  Drupal.behaviors.textSummary = {
    attach: function (context, settings) {
      $(context).find('.field--widget-text-textarea-with-summary').once('text-summary').each(function () {
        ...
        var $link = $('<span class="field-edit-link"><button type="button" class="link link-edit-summary btn btn-info btn-xs pull-right" data-toggle="button" aria-pressed="false" autocomplete="off">' + Drupal.t('Hide summary') + '</button></span>');
